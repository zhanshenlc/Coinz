...
public class FriendTest {
    ...
    public void friendTest() {
        ...
        ViewInteraction appCompatImageButton2 = onView(
                allOf(withId(R.id.addFriend_friendList), withContentDescription("Add a friend"),
                        childAtPosition(
                                allOf(withId(R.id.toolbar_friendList),
                                        childAtPosition(
                                                withClassName(is("android.support.constraint.ConstraintLayout")),
                                                0)),
                                1),
        ...
        ViewInteraction imageButton = onView(
                allOf(withId(R.id.addFriendbtn_addFriend), withContentDescription("Add a friend"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatImageButton3 = onView(
                allOf(withContentDescription("Navigate up"),
                        childAtPosition(
                                allOf(withId(R.id.toolbar_addFriend),
                                        childAtPosition(
                                                withClassName(is("android.support.constraint.ConstraintLayout")),
                                                0)),
                                1),
        ...
        ViewInteraction imageView = onView(
                allOf(withContentDescription("Coinz logo"),
                        childAtPosition(
                                childAtPosition(
